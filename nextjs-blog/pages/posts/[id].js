...
// Gets the id as a param from the name of the file [id]
...
with getStaticProps, and cached for future requests so it only happens once 
per path.
...
export async function getStaticPaths() {
	...
	/*
	// If three dots are put as this: [...id].js
	return [
		{
			params: {
